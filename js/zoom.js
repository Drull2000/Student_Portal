...
const zoomLessons = [
    ...
    { name: 'Офисные Технологии', teacher: 'Вакарчук Анна Олександровна', description: 'Еженедельное онлайн-занятие по офисным технологиям.', url: 'https://us04web.zoom.us/j/8129601850?pwd=aS9iYUs2VUxwU3c4d1RnSGNsNURFZz09' },
...
renderResources('zoom-list', zoomLessons, 'Zoom', 'Открыть Zoom', 'Ссылки Zoom пока не добавлены.');
